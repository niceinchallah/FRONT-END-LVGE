...
const generateRandomCarData = () => {
  ...
  const carData = [];
  for (let i = 0; i < 50; i++) { // Adjust the loop limit to generate more data
    carData.push({
...
const History = () => {
  ...
  return (
    <PageContainer title="Vehicles  Data" description="Table representing vehicle detection data">
      <DashboardCard title=" vehicles washed ">
